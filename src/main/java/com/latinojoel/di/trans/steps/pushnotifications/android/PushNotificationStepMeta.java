/*
 * Pentaho Data Integration Android Push Notifications https://github.com/latinojoel/pdi-android-pushnotifications
 * 
...
public class PushNotificationStepMeta extends BaseStepMeta implements StepMetaInterface {
    ...
    public String getXML() {
        ...
        for (int i = 0; i < dataFieldPush.size(); i++) {
            ...
            retval.append("          ").append(XMLHandler.addTagValue("dataFieldPush", dataFieldPush.get(i)));
    ...
    public void saveRep(Repository rep, ObjectId idTransformation, ObjectId idStep) throws KettleException {
        try {
            ...
            rep.saveStepAttribute(idTransformation, idStep, "restrictedPackageName", restrictedPackageName);
            ...
            final int nrRows = fieldStream.size() < dataFieldPush.size() ? dataFieldPush.size() : fieldStream.size();
            for (int i = 0; i < nrRows; i++) {
